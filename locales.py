...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "Reviews This Month": {
        "de": "Reviews This Month",
        "es": "Reviews This Month",
        "ko": "Reviews This Month",
        "pt": "Cartões no mês",
        "fr": "Reviews This Month",
        "vi": "Reviews This Month",
        "zh": "Reviews This Month",
        "hi": "Reviews This Month",
    },
    "Configure Daily Challenge": {
        "de": "Tages-Challenge konfigurieren",
        "es": "Configurar reto diario",
        "ko": "오늘의 챌린지 설정",
        "pt": "Configurar desafio diário",
        "fr": "Configurer le défi quotidien",
        "vi": "Cấu hình thử thách hàng ngày",
        "zh": "配置每日挑战",
        "hi": "दैनिक चुनौती कॉन्फ़िगर करें",
    },
    "Daily Challenge Settings": {
        "de": "Einstellungen für die Tages-Challenge",
        "es": "Ajustes del reto diario",
        "ko": "오늘의 챌린지 설정",
        "pt": "Configurações do desafio diário",
        "fr": "Paramètres du défi quotidien",
        "vi": "Cài đặt thử thách hàng ngày",
        "zh": "每日挑战设置",
        "hi": "दैनिक चुनौती सेटिंग्स",
    },
    "Fixed": {
        "de": "Fest",
        "es": "Fijo",
    ...
    "By Day of Week": {
        ...
        "zh": "按星期几",
        "hi": "सप्ताह के दिन के अनुसार",
    },
    "Same challenge every day.": {
        "de": "Jeden Tag dieselbe Challenge.",
        "es": "El mismo reto cada día.",
        "ko": "매일 같은 챌린지입니다.",
        "pt": "O mesmo desafio todos os dias.",
        "fr": "Le même défi chaque jour.",
        "vi": "Cùng một thử thách mỗi ngày.",
        "zh": "每天都是同一个挑战。",
        "hi": "हर दिन वही चुनौती।",
    },
    "Pick a challenge for each day of the week. Days left as \"Random\" get a random challenge.": {
        "de": "Wähle für jeden Wochentag eine Challenge. Tage, die auf \"Zufällig\" stehen, erhalten eine zufällige Challenge.",
        "es": "Elige un reto para cada día de la semana. Los días que queden en \"Aleatorio\" recibirán un reto aleatorio.",
        "ko": "요일마다 챌린지를 선택하세요. \"무작위\"로 남겨둔 요일은 무작위 챌린지가 배정됩니다.",
        "pt": "Escolha um desafio para cada dia da semana. Dias deixados como \"Aleatório\" recebem um desafio aleatório.",
        "fr": "Choisissez un défi pour chaque jour de la semaine. Les jours laissés sur \"Aléatoire\" reçoivent un défi aléatoire.",
        "vi": "Chọn một thử thách cho mỗi ngày trong tuần. Những ngày để \"Ngẫu nhiên\" sẽ nhận thử thách ngẫu nhiên.",
        "zh": "为每个星期几选择一个挑战。保留为\"随机\"的日期将获得随机挑战。",
        "hi": "सप्ताह के हर दिन के लिए एक चुनौती चुनें। जिन दिनों को \"यादृच्छिक\" छोड़ा जाएगा, उन्हें यादृच्छिक चुनौती मिलेगी।",
    },
    "No deck": {
        "de": "Kein Stapel",
        "es": "Sin mazo",
    ...
    "Mon": {"de": "Mo", "es": "Lun", "ko": "월", "pt": "Seg", "fr": "Lun", "vi": "T2", "zh": "周一", "hi": "सोम"},
    "Tue": {"de": "Di", "es": "Mar", "ko": "화", "pt": "Ter", "fr": "Mar", "vi": "T3", "zh": "周二", "hi": "मंगल"},
    "Wed": {"de": "Mi", "es": "Mié", "ko": "수", "pt": "Qua", "fr": "Mer", "vi": "T4", "zh": "周三", "hi": "बुध"},
    "Thu": {"de": "Do", "es": "Jue", "ko": "목", "pt": "Qui", "fr": "Jeu", "vi": "T5", "zh": "周四", "hi": "गुरु"},
    "Fri": {"de": "Fr", "es": "Vie", "ko": "금", "pt": "Sex", "fr": "Ven", "vi": "T6", "zh": "周五", "hi": "शुक्र"},
    "Sat": {"de": "Sa", "es": "Sáb", "ko": "토", "pt": "Sáb", "fr": "Sam", "vi": "T7", "zh": "周六", "hi": "शनि"},
    "Sun": {"de": "So", "es": "Dom", "ko": "일", "pt": "Dom", "fr": "Dim", "vi": "CN", "zh": "周日", "hi": "रवि"},
    "Next Level": {
        "de": "Nächstes Level",
        "es": "Siguiente nivel",
        "ko": "다음 레벨",
...
""",
    ...
    "Percentage of cards in your active collection that you have studied at least once.": {
        "de": "Percentage of cards in your active collection that you have studied at least once.",
        "es": "Percentage of cards in your active collection that you have studied at least once.",
        "ko": "Percentage of cards in your active collection that you have studied at least once.",
        "pt": "Porcentagem de cartões da sua coleção ativa que você já estudou pelo menos uma vez.",
        "fr": "Percentage of cards in your active collection that you have studied at least once.",
        "vi": "Percentage of cards in your active collection that you have studied at least once.",
        "zh": "Percentage of cards in your active collection that you have studied at least once.",
        "hi": "Percentage of cards in your active collection that you have studied at least once.",
    },
    "Daily Average": {
        "de": "Daily Average",
        "es": "Daily Average",
    ...
    "Average cards reviewed per day over the last 30 days.": {
        "de": "Average cards reviewed per day over the last 30 days.",
        "es": "Average cards reviewed per day over the last 30 days.",
        "ko": "Average cards reviewed per day over the last 30 days.",
        "pt": "Média de cartões revisados por dia nos últimos 30 dias.",
        "fr": "Average cards reviewed per day over the last 30 days.",
        "vi": "Average cards reviewed per day over the last 30 days.",
        "zh": "Average cards reviewed per day over the last 30 days.",
        "hi": "Average cards reviewed per day over the last 30 days.",
    },
    ...
    # ================================================================= #
    # Dashboard UX additions (streak-risk banner, rank overview, deck
    # filter, snapshot export, drag-to-reorder, study-plan empty state)
    # ================================================================= #
    "Your {}-day streak is at risk — you haven't studied today yet!": {
        "de": "Deine {}-Tage-Serie ist in Gefahr — du hast heute noch nicht gelernt!",
        "es": "¡Tu racha de {} días está en riesgo — todavía no has estudiado hoy!",
        "ko": "{}일 연속 기록이 위험해요 — 아직 오늘 학습을 안 하셨어요!",
        "pt": "Sua sequência de {} dias está em risco — você ainda não estudou hoje!",
        "fr": "Votre série de {} jours est en danger — vous n'avez pas encore étudié aujourd'hui !",
        "vi": "Chuỗi {} ngày của bạn đang gặp rủi ro — bạn chưa học hôm nay!",
        "zh": "你的 {} 天连续记录岌岌可危——你今天还没学习！",
        "hi": "आपकी {}-दिन की स्ट्रीक खतरे में है — आपने आज अभी तक पढ़ाई नहीं की!",
    },
    "Dismiss": {
        "de": "Verwerfen",
        "es": "Descartar",
    ...
    "Your Rank Progress": {
        "de": "Dein Rang-Fortschritt",
        "es": "Tu progreso de rango",
        "ko": "내 랭크 진행 상황",
        "pt": "Seu progresso de ranking",
        "fr": "Votre progression de rang",
        "vi": "Tiến trình thăng hạng của bạn",
        "zh": "你的段位进度",
        "hi": "आपकी रैंक प्रगति",
    },
    "Lvl": {
    ...
    "Level {} • {} XP total": {
        "de": "Level {} • {} XP insgesamt",
        "es": "Nivel {} • {} XP en total",
        "ko": "레벨 {} • 총 {} XP",
        "pt": "Nível {} • {} XP no total",
        "fr": "Niveau {} • {} XP au total",
        "vi": "Cấp {} • Tổng {} XP",
        "zh": "等级 {} • 共 {} XP",
        "hi": "लेवल {} • कुल {} XP",
    },
    "vs. previous {} days": {
        "de": "vs. vorherige {} Tage",
        "es": "vs. los {} días anteriores",
        "ko": "이전 {}일 대비",
        "pt": "vs. os {} dias anteriores",
        "fr": "vs. les {} jours précédents",
        "vi": "so với {} ngày trước đó",
        "zh": "对比之前 {} 天",
        "hi": "पिछले {} दिनों की तुलना में",
    },
    "Filter statistics by deck": {
        "de": "Statistiken nach Stapel filtern",
        "es": "Filtrar estadísticas por mazo",
        "ko": "덱별로 통계 필터링",
        "pt": "Filtrar estatísticas por baralho",
        "fr": "Filtrer les statistiques par paquet",
        "vi": "Lọc thống kê theo bộ thẻ",
        "zh": "按牌组筛选统计数据",
        "hi": "डेक के अनुसार आँकड़े फ़िल्टर करें",
    },
    "Export dashboard snapshot as PNG": {
        "de": "Dashboard-Schnappschuss als PNG exportieren",
        "es": "Exportar una instantánea del panel como PNG",
        "ko": "대시보드 스냅샷을 PNG로 내보내기",
        "pt": "Exportar um retrato do painel em PNG",
        "fr": "Exporter un instantané du tableau de bord en PNG",
        "vi": "Xuất ảnh chụp bảng điều khiển dạng PNG",
        "zh": "将仪表盘快照导出为 PNG",
        "hi": "डैशबोर्ड स्नैपशॉट को PNG के रूप में निर्यात करें",
    },
    "All decks": {
        "de": "Alle Stapel",
        "es": "Todos los mazos",
        "ko": "모든 덱",
        "pt": "Todos os baralhos",
        "fr": "Tous les paquets",
        "vi": "Tất cả bộ thẻ",
        "zh": "所有牌组",
        "hi": "सभी डेक",
    },
    "Could not access the dashboard view.": {
        "de": "Die Dashboard-Ansicht konnte nicht aufgerufen werden.",
        "es": "No se pudo acceder a la vista del panel.",
        "ko": "대시보드 화면에 접근할 수 없습니다.",
        "pt": "Não foi possível acessar a visualização do painel.",
        "fr": "Impossible d'accéder à l'affichage du tableau de bord.",
        "vi": "Không thể truy cập màn hình bảng điều khiển.",
        "zh": "无法访问仪表盘视图。",
        "hi": "डैशबोर्ड दृश्य तक नहीं पहुंचा जा सका।",
    },
    "Nothing to export yet.": {
        "de": "Noch nichts zum Exportieren.",
        ...
        "zh": "目前没有可导出的内容。",
        "hi": "अभी निर्यात करने के लिए कुछ नहीं है।",
    },
    "Export Dashboard Snapshot": {
        "de": "Dashboard-Schnappschuss exportieren",
        "es": "Exportar instantánea del panel",
        "ko": "대시보드 스냅샷 내보내기",
        "pt": "Exportar retrato do painel",
        "fr": "Exporter l'instantané du tableau de bord",
        "vi": "Xuất ảnh chụp bảng điều khiển",
        "zh": "导出仪表盘快照",
        "hi": "डैशबोर्ड स्नैपशॉट निर्यात करें",
    },
    "Snapshot saved: {}": {
        "de": "Schnappschuss gespeichert: {}",
        "es": "Instantánea guardada: {}",
        "ko": "스냅샷 저장됨: {}",
        "pt": "Retrato salvo: {}",
        "fr": "Instantané enregistré : {}",
        "vi": "Đã lưu ảnh chụp: {}",
        "zh": "快照已保存：{}",
        "hi": "स्नैपशॉट सहेजा गया: {}",
    },
    "Could not save the snapshot.": {
        "de": "Der Schnappschuss konnte nicht gespeichert werden.",
        "es": "No se pudo guardar la instantánea.",
        "ko": "스냅샷을 저장할 수 없습니다.",
        "pt": "Não foi possível salvar o retrato.",
        "fr": "Impossible d'enregistrer l'instantané.",
        "vi": "Không thể lưu ảnh chụp.",
        "zh": "无法保存快照。",
        "hi": "स्नैपशॉट सहेजा नहीं जा सका।",
    },
    "Drag to reorder": {
        "de": "Zum Neuanordnen ziehen",
        "es": "Arrastra para reordenar",
        "ko": "드래그하여 순서 변경",
        "pt": "Arraste para reorganizar",
    ...
    # ================================================================= #
    # Dashboard additions round 2 (weekly/deck goals, best-hour insight,
    # yearly heatmap, due forecast, pomodoro XP, OS reminder, theme schedule)
    # ================================================================= #
    "\n+{} XP": {
        "de": "\n+{} XP", "es": "\n+{} XP", "ko": "\n+{} XP", "pt": "\n+{} XP",
        "fr": "\n+{} XP", "vi": "\n+{} XP", "zh": "\n+{} XP", "hi": "\n+{} XP",
    ...
    "Weekly Goal": {
        ...
        "vi": "Mục tiêu hàng tuần",
        "zh": "每周目标",
        "hi": "साप्ताहिक लक्ष्य",
    },
    "{} / {} cards this week": {
        "de": "{} / {} Karten diese Woche",
        "es": "{} / {} tarjetas esta semana",
        "ko": "이번 주 {} / {}장",
        "pt": "{} / {} cartões esta semana",
        "fr": "{} / {} cartes cette semaine",
        "vi": "{} / {} thẻ tuần này",
        "zh": "本周 {} / {} 张卡片",
        "hi": "इस सप्ताह {} / {} कार्ड",
    },
    "Configure Weekly Goal": {
        "de": "Wochenziel einstellen",
        "es": "Configurar meta semanal",
        "ko": "주간 목표 설정",
        "pt": "Configurar meta semanal",
        "fr": "Configurer l'objectif hebdomadaire",
        "vi": "Thiết lập mục tiêu hàng tuần",
        "zh": "配置每周目标",
        "hi": "साप्ताहिक लक्ष्य कॉन्फ़िगर करें",
    },
    "How many cards would you like to review each week? Set to 0 to disable.": {
        "de": "Wie viele Karten möchtest du jede Woche wiederholen? 0 = deaktiviert.",
        "es": "¿Cuántas tarjetas te gustaría repasar cada semana? Pon 0 para desactivar.",
        "ko": "매주 몇 장의 카드를 복습하고 싶으신가요? 0으로 설정하면 비활성화됩니다.",
        "pt": "Quantos cartões você gostaria de revisar por semana? Defina 0 para desativar.",
        "fr": "Combien de cartes souhaitez-vous réviser chaque semaine ? Mettez 0 pour désactiver.",
        "vi": "Bạn muốn ôn bao nhiêu thẻ mỗi tuần? Đặt 0 để tắt.",
        "zh": "你希望每周复习多少张卡片？设为 0 可禁用。",
        "hi": "आप हर सप्ताह कितने कार्ड दोहराना चाहेंगे? अक्षम करने के लिए 0 सेट करें।",
    },
    "Cards per week": {
        "de": "Karten pro Woche",
        "es": "Tarjetas por semana",
        "ko": "주당 카드 수",
        "pt": "Cartões por semana",
        "fr": "Cartes par semaine",
        "vi": "Số thẻ mỗi tuần",
        "zh": "每周卡片数",
        "hi": "प्रति सप्ताह कार्ड",
    },
    "Deck Goal": {
        "de": "Stapel-Ziel",
        "es": "Meta del mazo",
        "ko": "덱 목표",
        "pt": "Meta do baralho",
        "fr": "Objectif du paquet",
        "vi": "Mục tiêu bộ thẻ",
        "zh": "牌组目标",
        "hi": "डेक लक्ष्य",
    },
    "How many cards from this deck would you like to review each week? Set to 0 to remove the goal.": {
        "de": "Wie viele Karten aus diesem Stapel möchtest du jede Woche wiederholen? 0 entfernt das Ziel.",
        "es": "¿Cuántas tarjetas de este mazo te gustaría repasar cada semana? Pon 0 para quitar la meta.",
        "ko": "이 덱에서 매주 몇 장의 카드를 복습하고 싶으신가요? 0으로 설정하면 목표가 제거됩니다.",
        "pt": "Quantos cartões deste baralho você gostaria de revisar por semana? Defina 0 para remover a meta.",
        "fr": "Combien de cartes de ce paquet souhaitez-vous réviser chaque semaine ? Mettez 0 pour retirer l'objectif.",
        "vi": "Bạn muốn ôn bao nhiêu thẻ từ bộ thẻ này mỗi tuần? Đặt 0 để xóa mục tiêu.",
        "zh": "你希望每周从这个牌组复习多少张卡片？设为 0 可移除目标。",
        "hi": "इस डेक से आप हर सप्ताह कितने कार्ड दोहराना चाहेंगे? लक्ष्य हटाने के लिए 0 सेट करें।",
    },
    "Set weekly goal for this deck": {
        "de": "Wochenziel für diesen Stapel festlegen",
        "es": "Definir meta semanal para este mazo",
        "ko": "이 덱의 주간 목표 설정",
        "pt": "Definir meta semanal para este baralho",
        "fr": "Définir l'objectif hebdomadaire pour ce paquet",
        "vi": "Đặt mục tiêu hàng tuần cho bộ thẻ này",
        "zh": "为此牌组设置每周目标",
        "hi": "इस डेक के लिए साप्ताहिक लक्ष्य सेट करें",
    },
    "{} / {} this week": {
        "de": "{} / {} diese Woche",
        "es": "{} / {} esta semana",
    ...
    "You tend to perform best between {} ({:.0f}% accuracy, based on {} reviews).": {
        "de": "Du schneidest am besten zwischen {} ab ({:.0f}% Trefferquote, basierend auf {} Wiederholungen).",
        "es": "Sueles rendir mejor entre {} ({:.0f}% de aciertos, según {} repasos).",
        "ko": "{} 시간대에 가장 좋은 성과를 보입니다 ({} 회 복습 기준 정답률 {:.0f}%).",
        "pt": "Você costuma render melhor entre {} ({:.0f}% de acerto, com base em {} revisões).",
        "fr": "Vous performez généralement mieux entre {} ({:.0f}% de précision, sur {} révisions).",
        "vi": "Bạn thường học tốt nhất trong khoảng {} (độ chính xác {:.0f}%, dựa trên {} lượt ôn).",
        "zh": "你通常在 {} 之间表现最佳（正确率 {:.0f}%，基于 {} 次复习）。",
        "hi": "आप आमतौर पर {} के बीच सबसे अच्छा प्रदर्शन करते हैं ({} रिव्यू के आधार पर {:.0f}% सटीकता)।",
    },
    "Click for the full-year view.": {
        "de": "Klicken für die Jahresansicht.",
        "es": "Haz clic para ver la vista anual.",
        "ko": "클릭하면 연간 보기가 표시됩니다.",
        "pt": "Clique para ver a visão do ano inteiro.",
        "fr": "Cliquez pour la vue annuelle.",
        "vi": "Nhấp để xem toàn năm.",
        "zh": "点击查看全年视图。",
        "hi": "पूरे साल का दृश्य देखने के लिए क्लिक करें।",
    },
    "Yearly Activity": {
        "de": "Jahresaktivität",
        "es": "Actividad anual",
        "ko": "연간 활동",
        "pt": "Atividade do ano",
        "fr": "Activité annuelle",
        "vi": "Hoạt động trong năm",
        "zh": "年度活动",
        "hi": "वार्षिक गतिविधि",
    },
    "Next {} Days": {
    ...
    "You haven't studied yet today — a quick review session keeps your streak alive!": {
        "de": "Du hast heute noch nicht gelernt — eine kurze Wiederholung erhält deine Serie!",
        "es": "Todavía no has estudiado hoy — ¡una sesión rápida mantiene tu racha viva!",
        "ko": "아직 오늘 학습을 하지 않으셨어요 — 짧은 복습으로 연속 기록을 지켜보세요!",
        "pt": "Você ainda não estudou hoje — uma revisão rápida mantém sua sequência viva!",
        "fr": "Vous n'avez pas encore étudié aujourd'hui — une révision rapide garde votre série en vie !",
        "vi": "Bạn chưa học hôm nay — một buổi ôn nhanh sẽ giữ chuỗi ngày học của bạn!",
        "zh": "你今天还没学习——快速复习一下就能保住连续记录！",
        "hi": "आपने आज अभी तक पढ़ाई नहीं की — एक त्वरित रिव्यू सेशन आपकी स्ट्रीक बचाए रखेगा!",
    },
    "Daily Study Reminder (system notification)": {
        "de": "Tägliche Lern-Erinnerung (Systembenachrichtigung)",
        "es": "Recordatorio diario de estudio (notificación del sistema)",
        "ko": "매일 학습 알림 (시스템 알림)",
        "pt": "Lembrete diário de estudo (notificação do sistema)",
        "fr": "Rappel d'étude quotidien (notification système)",
        "vi": "Nhắc học hằng ngày (thông báo hệ thống)",
        "zh": "每日学习提醒（系统通知）",
        "hi": "दैनिक अध्ययन अनुस्मारक (सिस्टम सूचना)",
    },
    "If you haven't studied by 20:00, shows a system notification. Anki must be running (even in the background) to fire it.": {
        "de": "Zeigt eine Systembenachrichtigung, falls du bis 20:00 Uhr nicht gelernt hast. Anki muss dafür laufen (auch im Hintergrund).",
        "es": "Si no has estudiado antes de las 20:00, muestra una notificación del sistema. Anki debe estar en ejecución (aunque sea en segundo plano) para activarla.",
        "ko": "20시까지 학습하지 않으면 시스템 알림을 표시합니다. 알림이 울리려면 Anki가 실행 중이어야 합니다(백그라운드여도 가능).",
        "pt": "Se você ainda não tiver estudado até as 20h, mostra uma notificação do sistema. O Anki precisa estar aberto (mesmo em segundo plano) para disparar.",
        "fr": "Si vous n'avez pas étudié avant 20h, affiche une notification système. Anki doit être ouvert (même en arrière-plan) pour la déclencher.",
        "vi": "Nếu bạn chưa học trước 20:00, sẽ hiện thông báo hệ thống. Anki phải đang chạy (kể cả ở chế độ nền) để thông báo hoạt động.",
        "zh": "如果到 20:00 你还没学习，会显示系统通知。Anki 必须处于运行状态（即使在后台）才能触发。",
        "hi": "यदि आपने शाम 8 बजे तक पढ़ाई नहीं की है, तो एक सिस्टम सूचना दिखाई जाएगी। इसे चलाने के लिए Anki का चलना (बैकग्राउंड में भी) आवश्यक है।",
    },
    "Scheduled Dark Theme": {
        "de": "Geplantes dunkles Design",
        "es": "Tema oscuro programado",
        "ko": "예약된 다크 테마",
        "pt": "Tema escuro agendado",
        "fr": "Thème sombre programmé",
        "vi": "Lên lịch giao diện tối",
        "zh": "定时深色主题",
        "hi": "शेड्यूल की गई डार्क थीम",
    },
    "Automatically switches Anki to dark theme from 20:00 to 07:00, independent of the manual night-mode toggle.": {
        "de": "Schaltet Anki automatisch von 20:00 bis 07:00 Uhr auf das dunkle Design um, unabhängig vom manuellen Nachtmodus-Schalter.",
        "es": "Cambia Anki automáticamente al tema oscuro de 20:00 a 07:00, independientemente del interruptor manual del modo nocturno.",
        "ko": "수동 야간 모드 전환과 관계없이 20시부터 07시까지 Anki를 자동으로 다크 테마로 전환합니다.",
        "pt": "Alterna o Anki automaticamente para o tema escuro das 20h às 7h, independente do alternador manual de modo noturno.",
        "fr": "Bascule automatiquement Anki en thème sombre de 20h à 7h, indépendamment du bouton manuel du mode nuit.",
        "vi": "Tự động chuyển Anki sang giao diện tối từ 20:00 đến 07:00, độc lập với công tắc chế độ ban đêm thủ công.",
        "zh": "自动在 20:00 至 07:00 之间将 Anki 切换为深色主题，独立于手动夜间模式开关。",
        "hi": "मैन्युअल नाइट-मोड टॉगल से स्वतंत्र, रात 8 बजे से सुबह 7 बजे तक Anki को स्वचालित रूप से डार्क थीम पर बदल देता है।",
    },
