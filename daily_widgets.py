...
# Custom modal HTML for control buttons (pause, reset, etc.)
    ...
    if grid_mode:
        widget_style = f"{base_style} grid-column: 1 / span 2; grid-row: 1 / span 2; width: 100%; height: 100%; min-height: 0; box-sizing: border-box; display: flex; flex-direction: column; justify-content: flex-start; overflow-y: auto;"
    else:
